char* getNote(double freq);
double lookupNote(char* name);
int sameName(char* n1, char* n2, int len);
...
char* getNote(double freq) { // Get note name from frequency
	int i = 0;
...
double lookupNote(char* name) { // Get reference frequency from note name
	int i = 0;
